...
<nav class="navbar fixed-top navbar-expand-sm navbar-dark" style="background-color:rgba(0,0,0,0.5)">
            <div class="container">
                    <a href="index.php" class="navbar-brand">PDT Shop</a>
                        ...
                        <li class="nav-item dropdown">
                          <a href="" class="nav-link dropdown-toggle" id="navbar-drop" data-toggle="dropdown">
                            <div class="dropdown-menu">
                              ...
                              <span class="dropdown-item" style="font-size: 30px">💖</span>
            ...
            <div class="modal-body">
              <form action="login_script.php" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" id="pwd2"  name="lpassword" placeholder="Password" required>
                </div>
